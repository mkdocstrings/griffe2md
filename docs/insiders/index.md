...
*griffe2md* follows the **sponsorware** release strategy, which means
...
*griffe2md Insiders* is a private fork of *griffe2md*, hosted as
...
repository.
  ...
  [^1]:
    ...
    existing features that must be supported by *griffe2md*.
...
*griffe2md* and released for general availability, making them available
...
The biggest bottleneck in Open Source is time.[^3]
  ...
  [^3]:
    ...
    The sponsorware model ensures that if you decide to use *griffe2md*,
...
<small>
  ...
  your profile and avatar to show your support for *griffe2md*.
...
to use *griffe2md* locally without having access to Insiders.
Is this still possible?

Yes. Insiders is compatible with *griffe2md*. Almost all new features
...
Yes. Whether you're an individual or a company, you may use *griffe2md
Insiders* precisely under the same terms as *griffe2md*, which are given
